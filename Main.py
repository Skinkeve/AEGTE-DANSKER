...
class Gamecards():
    ...
    def Guessdf(self):
        ...
        if self.number == 1:
            ...
            print("2.", random.choice(self.falsestatement1))
            print("3.", random.choice(self.falsestatement2))
            print("4.", random.choice(self.falsestatement3))
        elif self.number == 2:
            print("1.", random.choice(self.falsestatement1))
            print("2.", random.choice(self.truestatements))
            print("3.", random.choice(self.falsestatement2))
            print("4.", random.choice(self.falsestatement3))
        elif self.number == 3:
            print("1.", random.choice(self.falsestatement1))
            print("2.", random.choice(self.falsestatement2))
            print("3.", random.choice(self.truestatements))
            print("4.", random.choice(self.falsestatement3))
        elif self.number == 4:
            print("1.", random.choice(self.falsestatement1))
            print("2.", random.choice(self.falsestatement2))
            print("3.", random.choice(self.falsestatement3))
            print("4.", random.choice(self.truestatements))
        self.answer = input("Angiv med tal hvilket citat er fra DF\n")
